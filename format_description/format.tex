...
\begin{table}[hb!]
  ...
  \begin{tikzpicture}
    ...
    \draw[-Straight Barb, thick, shorten <=10mm, shorten >=5mm]
    (m.north) --
    (m.north west);
    \draw[]
    (m.north) node[centered] {1792 bits};
    \draw[Straight Barb-, thick, shorten <=5mm, shorten >=10mm]
    (m.north east) --
    (m.north);
...
\begin{figure}[hb!]
  ...
  \begin{subfigure}[hb!]{0.5\textwidth}
    ...
    \begin{bytefield}[lsb=32,bitheight=4ex,bitwidth=4ex,boxformatting={\centering\small}]{8}
      \bitheader[endianness=little]{32,35,36,39} \\
  ...
  \begin{subfigure}[hb!]{0.5\textwidth}
    ...
    \begin{bytefield}[lsb=32,bitheight=4ex,bitwidth=4ex,boxformatting={\centering\small}]{8}
      ...
      \bitboxes{1}{01110000}\\
    \end{bytefield}
    \caption{Marker 7 and Sub Marker 0}
  \end{subfigure}%
  \begin{subfigure}[hb!]{0.5\textwidth}
    \centering
    \begin{bytefield}[lsb=32,bitheight=4ex,bitwidth=4ex,boxformatting={\centering\small}]{8}
